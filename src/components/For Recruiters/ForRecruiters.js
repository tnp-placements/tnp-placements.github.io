    ...
    <div className="flex w-full flex-col gap-10 py-5" id="recruiters">
      <div className="px-10 2xl:px-40">
       ...
       <div>
            ...
            <h2>Below is a detailed description of internship and Placements availability (date & duration) for various courses at the university. The dates mentioned below for the exam and internship are tentative, it all depends on the release of the last date sheet scheduled 10-15 days before the exam</h2>
            <div className="flex flex-col xl:flex-row xl:items-center">
            <table border="1" cellPadding="10" cellSpacing="0">
                <thead>
                    <tr>
                        <th>Degree</th>
                        <th>Internship Availability</th>
                        <th>Tentative Dates</th>
                        <th>Full Time Joining Dates</th>
                        <th>Passing Year</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>B.Tech (2025 passing)</td>
                        <td>6 MONTHS</td>
                        <td>01 JAN 2025 to 30 JUNE 2025</td>
                        <td>July 2025</td>
                        <td>July 2025</td>
                    </tr>
                    <tr>
                        <td>B.Tech (2026 passing)</td>
                        <td>2 MONTHS</td>
                        <td>24 MAY 2025 to 25 JULY 2025</td>
                        <td>July 2026</td>
                        <td>July 2026</td>
                    </tr>
                    <tr>
                        <td>M.Tech (2025 Passing)</td>
                        <td>6 MONTHS</td>
                        <td>01 JAN 2025 to 30 JUNE 2025</td>
                        <td>July 2025</td>
                        <td>July 2025</td>
                    ...
                    <tr>
                        <td>M.Tech (2026 Passing)</td>
                        <td>6 MONTHS</td>
                        <td>01 JAN 2026 to 30 JUNE 2026</td>
                        <td>July 2026</td>
                        <td>July 2026</td>
                    </tr>
                    <tr>
                        <td>M.Sc (2025 Passing)</td>
                        <td>4 MONTHS</td>
                        <td>01 JAN 2025 to 30 April 2025</td>
                        <td>June 2025</td>
                        <td>June 2025</td>
                    </tr>
                    <tr>
                        <td>B.Design (2025 Passing)</td>
                        <td>6 MONTHS</td>
                        <td>01 JAN 2025 to 30 JUNE 2025</td>
                        <td>July 2025</td>
                        <td>July 2025</td>
                    ...
                    <tr>
                        <td>MA (2025 Passing)</td>
                        <td>2 MONTHS</td>
                        <td>24 MAY 2024 to 25 JULY 2024</td>
                        <td>June 2025</td>
                        <td>June 2025</td>
                    </tr>
                </tbody>
