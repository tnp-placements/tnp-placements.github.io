...
export const about = {
    ...
    list1: "Technical Profiles: Microsoft, Google, Adobe, Goldman Sachs, Rubrik, Tower Research Capital, Uber, Salesforce, D.E. Shaw, Atlassian, PayPal, PhonePe, Walmart, Zomato, Morgan Stanley, Arcesium, Cisco, Fast Retailing (Japan), Expedia Group, Samsung, Intuit, MyKaarma, Urban Company, Visa, and Media.net",
    list2: "Non-Technical Domain: Bain and Company, JPMorgan, ZS Associates, McKinsey and Company, BlackRock Group, American Express, KPMG, E&Y, Axis Bank, Axxela, RBL Bank, EXL, Mastercard, Future First, LEK, and Thorogood.",
    list3: "Core Domain: Texas Instruments, Nvidia, Qualcomm, Cadence, Samsung, Bharti Airtel, Reliance, Vedanta, Schlumberger, Maruti, Anand Motors, Hero Moto Corp, Siemens, ARM, Jubilant Foodworks, GAIL, CDOT, and BEL ",
    cardDetails: [
        {
            imgUrl: Campus,
            title: "Campus",
